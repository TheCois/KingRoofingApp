...
[assembly: WebActivator.PreApplicationStartMethod(typeof(KRF.Web.App_Start.HtmlMicrodataFormatterActivator), "ConfigureHtmlMicrodataFormatter")]

// This part configures routes that generate documentation, forms and links for your project at ~/api and ~/api/doc/{typeName}:
[assembly: WebActivator.PreApplicationStartMethod(typeof(KRF.Web.App_Start.HtmlMicrodataFormatterActivator), "ConfigureDocumentationProvider")]
...
namespace KRF.Web.App_Start
{
    public static class HtmlMicrodataFormatterActivator
    {
        ...
        private static MediaTypeFormatter CreateHtmlMicrodataFormatter(HttpConfiguration config)
        {
            ...
            formatter.AddHeadContent(new XElement("title", "KRF.Web"));
